...
public class ClassifierService {
    ...
    public Classification[] classifyInstanceTop3(Instance instance) {
        ...
        for (int i = 0; i < distributionArray.length; i++) {
            Classification c = new Classification(instance.classAttribute()
                                                          .value(i),
                    distributionArray[i]);
    ...
    public Classification classifyInstanceWithLemma(Instance instance, String lemma) {
        ...
        clazz = top3clazz[0];
        for (int i = 2; i >= 0; i--) {
            if (top3clazz[i].getClassificationString()
                            .toLowerCase()
                            .contains(lemma)
    ...
    public String toString() {
        String classifierString = classifier != null ? classifier.getClass()
                                                                 .getName()
                : "null";
        String filterString = classifier != null ? filter.getClass()
                                                         .getName()
                : "null";
